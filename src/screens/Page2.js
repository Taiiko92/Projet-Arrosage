...
import { View, ImageBackground, StyleSheet, Modal, TouchableOpacity, Animated, Text } from 'react-native';
...
const Page2 = () => {
  ...
  // Exemple de données pour les soins des plantes
  const InfoPlantes = [
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Ajoutez le composant Informations ici */}
        <Informations data={InfoPlantes} />
